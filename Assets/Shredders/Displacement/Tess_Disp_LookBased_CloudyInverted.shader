...
Shader "CustomGraph/Tesselation Displacement look based lerp Inverted Cloudy Water" {
	 Properties {
        ...
        SubShader {
            ...
            void disp (inout appdata v)
            {
                ...
                float m = min(1.0, l/_LookDist);
               //	m = sqrt(m);
                float change = 1.0 - m;
                //customChange *= customChange;
                
                v.vertex.xyz += v.normal * lerp(targetD, d, change * _Change);
            }
            ...
            void surf (Input IN, inout SurfaceOutput o) {
               ...
               //	m = sqrt(m);
                ...
                o.Normal = lerp(targetN, n, change * _Change);
            }
            ENDCG
        }
        FallBack "Diffuse"
