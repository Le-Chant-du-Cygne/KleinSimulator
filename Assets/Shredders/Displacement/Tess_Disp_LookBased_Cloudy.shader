...
Shader "CustomGraph/Tesselation Displacement look based lerp Cloudy Water" {
	 Properties {
        ...
        SubShader {
            ...
            void disp (inout appdata v)
            {
                ...
                v.vertex.xyz += v.normal * lerp(d, targetD, customChange * _Change);
            }
            ...
            void surf (Input IN, inout SurfaceOutput o) {
                ...
                o.Normal = lerp(n, targetN, change * _Change);
            }
            ENDCG
        }
        FallBack "Diffuse"
